          ...
          {pullLogs.length > 0 ? (
            <div className="overflow-x-auto">
              <table className="min-w-full divide-y divide-gray-200">
                <thead className="bg-gray-50">
                  <tr>
                    <th className="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase">장치 IP</th>
                    <th className="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase">엔드포인트</th>
                    <th className="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase">IP 개수</th>
                    <th className="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase">응답시간</th>
                    <th className="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase">상태</th>
                    <th className="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase">요청시각</th>
                ...
                <tbody className="bg-white divide-y divide-gray-200">
                  {pullLogs.map((log) => (
                    <tr key={log.id} className="hover:bg-gray-50">
                      ...
                      <td className="px-6 py-4">
                        <span className="text-sm text-gray-600 line-clamp-1">{log.user_agent || '-'}</span>
                      </td>
                    </tr>
                  ))}
                </tbody>
