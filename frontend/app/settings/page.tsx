          ...
          <div className="space-y-6">
            ...
            <div className="space-y-4">
              <div className="flex items-center justify-between">
                ...
                <button
                  onClick={() => setSystemSettings(s => ({ ...s, auto_deactivate_expired: !s.auto_deactivate_expired }))}
                  className={`relative inline-flex h-6 w-11 items-center rounded-full transition-colors ${
                    systemSettings.auto_deactivate_expired ? 'bg-blue-600' : 'bg-gray-200 dark:bg-gray-700'
                  }`}
                >
              ...
              <div>
                ...
                <input
                  ...
                  onChange={(e) => setSystemSettings(s => ({ ...s, collection_interval_hours: parseInt(e.target.value) || 24 }))}
              ...
              <div>
                ...
                <input
                  ...
                  onChange={(e) => setSystemSettings(s => ({ ...s, cache_ttl_seconds: parseInt(e.target.value) || 300 }))}
                  className="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-lg bg-white dark:bg-gray-700 text-gray-900 dark:text-white"
                  min="60"
                  max="3600"
                />
              ...
              <div>
                ...
                <input
                  ...
                  onChange={(e) => setSystemSettings(s => ({ ...s, max_batch_size: parseInt(e.target.value) || 1000 }))}
                  className="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-lg bg-white dark:bg-gray-700 text-gray-900 dark:text-white"
                  min="100"
                  max="10000"
                />
          ...
          <div className="space-y-6">
            ...
            <div className="grid grid-cols-2 gap-4">
              <div className="p-4 bg-gray-50 dark:bg-gray-700 rounded-lg">
                ...
                <p className="text-lg font-medium text-gray-900 dark:text-white">blacklist-postgres</p>
              </div>
              <div className="p-4 bg-gray-50 dark:bg-gray-700 rounded-lg">
            ...
            <div className="space-y-4">
              <div className="p-4 bg-yellow-50 dark:bg-yellow-900/20 border border-yellow-200 dark:border-yellow-800 rounded-lg">
                <p className="text-sm text-yellow-800 dark:text-yellow-200">
                  보안 설정은 관리자만 변경할 수 있습니다. 인증 정보는 수집 관리 페이지에서 관리하세요.
                </p>
              </div>
          ...
          <div className="space-y-6">
            ...
            <div className="space-y-4">
              <div className="flex items-center justify-between">
                ...
                <button
                  onClick={() => setNotificationSettings(s => ({ ...s, email_alerts: !s.email_alerts }))}
                  className={`relative inline-flex h-6 w-11 items-center rounded-full transition-colors ${
                    notificationSettings.email_alerts ? 'bg-blue-600' : 'bg-gray-200 dark:bg-gray-700'
                  }`}
                >
                  <span className={`inline-block h-4 w-4 transform rounded-full bg-white transition-transform ${
              ...
              <div className="flex items-center justify-between">
                ...
                <button
                  onClick={() => setNotificationSettings(s => ({ ...s, slack_alerts: !s.slack_alerts }))}
                  className={`relative inline-flex h-6 w-11 items-center rounded-full transition-colors ${
                    notificationSettings.slack_alerts ? 'bg-blue-600' : 'bg-gray-200 dark:bg-gray-700'
                  }`}
                >
                  <span className={`inline-block h-4 w-4 transform rounded-full bg-white transition-transform ${
              ...
              <div>
                ...
                <input
                  ...
                  onChange={(e) => setNotificationSettings(s => ({ ...s, alert_threshold: parseInt(e.target.value) || 100 }))}
                  className="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-lg bg-white dark:bg-gray-700 text-gray-900 dark:text-white"
                  min="10"
                  max="10000"
                />
